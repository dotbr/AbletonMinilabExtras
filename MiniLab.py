...
# Compiled at: 2020-01-14 12:08:47
...
class MiniLab(ArturiaControlSurface):
    ...
    def _create_controls(self):
        ...
        # added
        self._arm_button = ButtonElement(True, MIDI_CC_TYPE, self.encoder_msg_channel, 113, name='Arm_Button')
        self._mute_button = ButtonElement(True, MIDI_CC_TYPE, self.encoder_msg_channel, 115, name='Mute_Button')
        #
